    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p
            className='pt-4 md:text-xl text-xl'
                  ...
                  >
                    <div className='flex items-center gap-2'>
                      <img
                        ...
                        alt='arrow icon'
                      />
                      <p className='font-medium md:text-xl text-xl pr-3 text-green-800'>
                        {chapter.chapterTitle}
                      </p>
                    </div>
                    <p className='text-xl md:text-default pr-3 text-blue-800'>
                    ...
                    <ul className='list disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className='flex items-start gap-2 py-1'>
                          <img src={assets.play_icon} alt='play icon' className='w-4 h-4 mt-1 pb-1' />
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                            <p className='text-[14px]'>{lecture.lectureTitle}</p>
                            <div className='flex gap-2'>
                              ...
                              <p className='pt-0.5 text-green-600 text-[13px]'>
          ...
          <div className='py-20 text-sm md:text-default'>
            ...
            <p
              className='pt-3 rich-text text-xl'
        ...
        {/* right column */}
        <div className='max-w-md z-10 shadow-amber-600 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w[420px]'>
          {playerData ? (
            <YouTube videoId={playerData.videoId} opts={youtubeOpts} iframeClassName='w-full aspect-video' />
          ) : (
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
              <div className='flex items-center gap-1'>
                <img className='text-xl' src={assets.star} alt='star icon' />
                <p className='text-xl'>{calculateRating(courseData)}</p>
              </div>
              ...
              <div className='flex items-center gap-1'>
                ...
                <p className='text-xl'>{calculateNoOfLectures(courseData)} lessons</p>
              </div>
            </div>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-lg md:text-default list-disc text-gray-500'>
