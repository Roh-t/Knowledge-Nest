...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 w-full h-full bg-gradient-to-b from-cyan-100/70'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        {/* review and ratings  */}
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Rohit Singh</span></p>
              ...
              {courseData.courseContent.map((chapter,index)=> (
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96':'max-h-0'}`}>
                    <ul className='list disc md:pl-10 pl-4 pr-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                      {
